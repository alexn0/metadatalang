...
class CopyingForGetFunctionTest {


    inline fun StringFieldProperty.fieldCall(noinline f: Sp<String?>? = null): String? { return fieldBackedByGet(f)}

    inline fun StringFieldProperty.getCall(noinline f: Sp<String?>? = null): String? { return get(f) { null }}

    inline fun TestData<*>.isSet(name: String) = r.fieldSet(name)

    inline fun KtLazy.isSet(name: String) = fieldSet(name)

    val fieldName = StringFieldProperty::fieldBackedByGet.name
