...
package org.opt2code.code.calc
...
class CopyingForCalcFunctionTest {

    inline fun StringFieldProperty.fieldCall(noinline f: Sp<String?>? = null): String? { return field(f)}

    inline fun StringFieldProperty.getCall(noinline f: Sp<String?>? = null): String? { return calc(f) { null }}

    inline fun TestData<*>.isSet(name: String) = r.fieldSet(name)

    inline fun KtLazy.isSet(name: String) = fieldSet(name)

    val fieldName = StringFieldProperty::field.name
